...
export function buildAuthUrl(cfg: NonNullable<HanniConfig["openai"]>["oauth"], state: string, challenge: string) {
...
export async function exchangeCodeForToken(
  cfg: NonNullable<HanniConfig["openai"]>["oauth"],
  code: string,
  verifier: string,
): Promise<OAuthTokens> {
...
export function startOpenAITokenRefresher(config: HanniConfig, onUpdated?: () => void) {
...
export function applyCodexDefaults(cfg: NonNullable<HanniConfig["openai"]>["oauth"]) {
